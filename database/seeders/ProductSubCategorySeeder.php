...
class ProductSubCategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('product_sub_categories')->insert([
            ...
            [
                'id' => 13,
                'product_subcategory_name' => 'Camera',
                'product_subcategory_slug' => Str::slug('Camera'),
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => 14,
                'product_subcategory_name' => 'DVR & XVR',
                'product_subcategory_slug' => Str::slug('DVR & XVR'),
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => 15,
                'product_subcategory_name' => 'Accessories',
                'product_subcategory_slug' => Str::slug('Accessories'),
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
