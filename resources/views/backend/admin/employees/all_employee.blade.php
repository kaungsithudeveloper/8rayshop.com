                                            ...
                                            @foreach ($allemployee as $key => $employee)
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex">
                                                            <img src="{{ !empty($employee->photo) ? url('upload/employee_images/' . $employee->photo) : url('upload/profile.jpg') }}"
                                                                alt="Admin" style="width:30px; height: 30px;">
                                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                <h6 class="mb-0 fs-14 fw-semibold"> {{ $employee->name }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="mt-0 mt-sm-3 d-block">
                                                                <h6 class="mb-0 fs-14 fw-semibold"> {{ $employee->email }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="mt-0 mt-sm-3 d-block">
                                                                <h6 class="mb-0 fs-14 fw-semibold"> {{ $employee->phone }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="g-2 text-center">
                                                                ...
                                                                @if ($employee->status == 'active')
                                                                    <a href="{{ route('inactive.employee', $employee->id) }}"
                                                                ...
                                                                @else
                                                                    <a href="{{ route('active.employee', $employee->id) }}"
                                                                        class="btn text-primary btn-sm"
                                                                        data-bs-toggle="tooltip"
