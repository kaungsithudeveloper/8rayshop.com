...
<!-- typeahead -->
<script src="{{ url('backend/plugins/typeahead/typeahead.bundle.js') }}"></script>
<script src="{{ url('backend/plugins/select2/select2.full.min.js') }}"></script>
<script src="{{ url('backend/js/select2.js') }}"></script>


<!-- INTERNAL WYSIWYG Editor JS -->
<script src="{{ url('backend/plugins/wysiwyag/jquery.richtext.js') }}"></script>
<script src="{{ url('backend/plugins/wysiwyag/wysiwyag.js') }}"></script>
