        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <form id="myForm" method="post" action="{{ route('update.product.categories') }}" enctype="multipart/form-data">
                                @csrf
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="g-2 text-center">
                                                                ...
                                                                <a href="{{ route('edit.product.categories', $category->product_category_slug) }}"
                                                                    class="btn text-primary btn-sm" data-bs-toggle="tooltip"
                                                                    data-bs-original-title="Edit">
                                                                    <span class="fe fe-edit fs-14"></span>
                                                                </a>

                                                                <a href="{{ route('delete.product.categories', $category->id) }}"
