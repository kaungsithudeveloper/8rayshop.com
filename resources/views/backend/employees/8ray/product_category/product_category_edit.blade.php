        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Product Categories</h1>
                    <div>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <form id="myForm" method="post" action="{{ route('update.employee.product.categories') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="product_category_name" name="product_category_name" value="{{ old('product_category_name', $product_category->product_category_name) }}" required autofocus>
                                    </div>

                                    <div class="form-group">
                                        <label for="product_category_image">Product Categories Photo :</label>
                                        <input type="file" name="product_category_image" class="form-control" id="image" />
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage" src="{{ (!empty($product_category->product_category_image))?url('upload/product_category_images/'.$product_category->product_category_image):url('upload/profile.jpg') }}" alt="Admin">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table id="responsive-datatable"
                                        ...
                                        <thead class="border-top">
                                            <tr>
                                                ...
                                                <th class="bg-transparent border-bottom-0" style="width: 10%;"> Product Categories Image</th>
                                                <th class="bg-transparent border-bottom-0"> Product Categories Name</th>
                                            ...
                                            @foreach ($product_categories as $key => $category)
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex">
                                                            <img src="{{ !empty($category->product_category_image) ? url('upload/product_category_images/' . $category->product_category_image) : url('upload/profile.jpg') }}"
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="mt-0 mt-sm-3 d-block">
                                                                <h6 class="mb-0 fs-14 fw-semibold"> {{ $category->product_category_name }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="g-2 text-center">
                                                            ...
                                                            <a href="{{ route('edit.employee.product.categories', $category->product_category_slug) }}"
                                                                class="btn text-primary btn-sm" data-bs-toggle="tooltip"
                                                                data-bs-original-title="Edit">
                                                                <span class="fe fe-edit fs-14"></span>
                                                            </a>

                                                            <a href="{{ route('delete.employee.product.categories', $category->id) }}"
