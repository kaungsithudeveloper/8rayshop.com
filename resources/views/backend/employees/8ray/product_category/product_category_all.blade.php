        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <form id="myForm" method="post" action="{{ route('store.employee.product.categories') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="product_category_name" name="product_category_name" value="{{ old('product_category_name') }}" required autofocus>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage" src="{{ (!empty($product_categories->Product_category_image))?url('upload/product_category_images/'.$product_categories->Product_category_image):url('upload/profile.jpg') }}" alt="Admin">
                                        </div>
                                    </div>
                                </div>
