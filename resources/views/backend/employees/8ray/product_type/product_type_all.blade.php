        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">All Product Type</h1>
                    <div>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <form id="myForm" method="post" action="{{ route('store.employee.product.types') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="product_type_name" name="product_type_name" value="{{ old('product_type_name') }}" required autofocus>
                                    </div>
                                </div>
                                    ...
                                    <table id="responsive-datatable"
                                        ...
                                        <thead class="border-top">
                                            <tr>
                                                ...
                                                <th class="bg-transparent border-bottom-0"> Product Type Name</th>
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="g-2 text-center">
                                                                ...
                                                                <a href="{{ route('edit.employee.product.types', $type->product_type_slug) }}"
                                                                    class="btn text-primary btn-sm" data-bs-toggle="tooltip"
                                                                    data-bs-original-title="Edit">
                                                                    <span class="fe fe-edit fs-14"></span>
                                                                </a>

                                                                <a href="{{ route('delete.employee.product.types', $type->id) }}"
