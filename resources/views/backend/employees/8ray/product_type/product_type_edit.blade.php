        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Product Type</h1>
                    <div>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <form id="myForm" method="post" action="{{ route('update.employee.product.types') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        value="{{ old('product_type_name', $product_type->product_type_name) }}" required autofocus>
                                    </div>
                                </div>
