                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <form id="myForm" method="post" action="{{ route('store.employee.user') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body">
                                                <div class="">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-9 text-secondary">
                                                            <img id="showImage" src="{{ (!empty($admin->photo))?url('upload/user_images/'.$admin->photo):url('upload/profile.jpg') }}" alt="Employee" style="width:100px; height: 150px;" >
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
