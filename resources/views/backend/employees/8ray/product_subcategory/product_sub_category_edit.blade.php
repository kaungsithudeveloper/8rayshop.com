        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Product SubCategories</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Product SubCategories</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <form id="myForm" method="post" action="{{ route('update.employee.product.sub_categories') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $product_subcategory->id }}">
                                <div class="card-header">
                                    <h4 class="card-title">Edit Product SubCategory</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <select name="product_categories_id" class="form-control form-select" data-bs-placeholder="Select Product Category">
                                            @foreach($product_categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ $product_subcategory->productCategories->contains($category->id) ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="product_subcategory_name" name="product_subcategory_name" value="{{ old('product_subcategory_name', $product_subcategory->product_subcategory_name) }}" required autofocus>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-primary">Update SubCategories</button>
                                    </div>
                                </div>
                            </form>
                        </div>
