                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            @if($order->status == 'pending')
                                                <a href="{{ route('employee.pending-confirm',$order->id) }}" class="btn btn-block btn-success" id="confirm">Confirm Order</a>

                                            @elseif($order->status == 'confirm')
                                                <a href="{{ route('employee.confirm-processing',$order->id) }}" class="btn btn-block btn-success" id="processing">Processing Order</a>

                                            @elseif($order->status == 'processing')
                                                <a href="{{ route('employee.processing-delivered',$order->id) }}" class="btn btn-block btn-success" id="delivered">Delivered Order</a>
                                            @endif

                                            <!-- Cancel Order Button -->
                                            <a href="{{ route('employee.processing-cancel', $order->id) }}" class="btn btn-block btn-danger" id="cancel">Order Cancel</a>
                                        </th>
