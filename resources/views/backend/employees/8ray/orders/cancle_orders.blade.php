        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">All Cancel Order</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">All Cancle Order</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="g-2 text-center">
                                                            <a href="{{ route('employee.order.details',$item->id) }}"
