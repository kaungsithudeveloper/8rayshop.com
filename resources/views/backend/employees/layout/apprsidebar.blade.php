                ...
                <div class="tab-pane" id="side2">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/2.jpg') }}"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/11.jpg') }}"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/10.jpg') }}"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/13.jpg') }}"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/12.jpg') }}"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/15.jpg') }}"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/4.jpg') }}"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/7.jpg') }}"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/9.jpg') }}"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/2.jpg') }}"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark">Addie Minstra</div>
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/14.jpg') }}"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/11.jpg') }}"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="{{ url('backend/images/users/4.jpg') }}"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark">Cherry Blossom</div>
