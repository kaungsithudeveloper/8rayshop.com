        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <form id="myForm" method="post" action="{{ route('update.product.sub_categories') }}" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <select name="product_categories_id" class="form-control form-select" data-bs-placeholder="Select Product Category">
                                                ...
                                                @foreach($product_categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ optional($product_subcategory->product_category)->id == $category->id ? 'selected' : '' }}>
