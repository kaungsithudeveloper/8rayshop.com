    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span>
                <a href="{{ url('product/category/'.$breadcat->id.'/'.$breadcat->product_category_slug) }}" rel="nofollow">
                    {{ $breadcat->product_category_name }}
                </a>
                <span></span>
                <a href="{{ url('product/subcategory/'.$breadsubcat->id.'/'.$breadsubcat->product_subcategory_slug) }}" rel="nofollow">
                    {{ $breadsubcat->product_subcategory_name }}
                </a>
            </div>
        </div>
    </div>
                        ...
                        <div class="pagination-area mt-20 mb-20">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $subcategoryProducts->previousPageUrl() }}" rel="prev"><i class="fi-rs-arrow-small-left"></i></a>
                                        </li>
                                    @endif
